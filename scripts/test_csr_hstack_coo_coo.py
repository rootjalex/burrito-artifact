...
def f_burrito(m0, m1):
    return burrito.csr_hstack_coo_coo(m0, m1)

def process_scipy(matrix):
    return split_matrix(matrix)

def f_scipy(m0, m1):
    return scipy.sparse.hstack([m0, m1], format="csr")
...
if __name__ == "__main__":
    tests = [
        tester.Tester("csr_hstack_coo_coo", "coo", process_burr, f_burrito, process_scipy, f_scipy, process_pydata, f_pydata, f_equals),
    ]
