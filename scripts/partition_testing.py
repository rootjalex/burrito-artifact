...
if __name__ == "__main__":
    ...
    tests = [
        ...
        # fusion
        tester.Tester("cv_collapse_csr_mul_cv", "csr", test_cv_collapse_csr_mul_cv.process_burr, test_cv_collapse_csr_mul_cv.f_burrito, test_cv_collapse_csr_mul_cv.process_scipy, test_cv_collapse_csr_mul_cv.f_scipy, test_cv_collapse_csr_mul_cv.process_burr_unfused, test_cv_collapse_csr_mul_cv.f_burr_unfused, test_cv_collapse_csr_mul_cv.f_equals),
